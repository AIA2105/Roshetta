...
class ScanPrescription {
  String _finalResult;

  Future<String> postPrescription(File image) async {
    //create multipart request for POST or PATCH method
    var request = http.MultipartRequest("POST", Uri.parse(Links().scan));
    //add text fields
  ...
  //   //create multipart request for POST or PATCH method
  //   var request = http.MultipartRequest("POST", Uri.parse(Links().prescription));
  //   //add text fields
