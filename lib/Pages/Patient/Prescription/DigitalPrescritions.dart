...
class DigitalPrescriptions extends StatefulWidget {
  const DigitalPrescriptions({Key key}) : super(key: key);
  @override
  _DigitalPrescriptionsState createState() => _DigitalPrescriptionsState();
}
